...
/**
 * Java ThreadPoolExecutor first add task to "com.iat.bigdl.core" threads, then it adds tasks to queue,
...
public class EagerThreadPoolExecutor extends ThreadPoolExecutor {
     ...
     *                          the com.iat.bigdl.core, this is the maximum time that excess idle threads
